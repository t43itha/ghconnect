    ...
    <div style={{ padding: "0 24px 120px" }}>
      <Reveal>
        <div style={{ paddingTop: 56, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <div style={{ width: 88, height: 88, borderRadius: "50%", background: T.ink, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: T.s2, position: "relative" }}>
            <span style={{ fontFamily: F.serif, fontSize: 38, fontWeight: 700, color: T.white }}>G</span>
